              ...
              <div className="flex-shrink-0 flex items-center px-4">
                <Link to="/dashboard" className="flex items-center">
                  <div className="h-8 w-8 bg-indigo-600 rounded-lg flex items-center justify-center">
                    <span className="text-white font-bold text-sm">CPJ</span>
                  </div>
                  <span className="ml-2 text-xl font-semibold text-gray-900">Consulta Procesos</span>
                </Link>
              </div>
              <nav className="mt-5 px-2 space-y-1">
                {navigation.map((item) => (
                  <Link
                    ...
                    onClick={() => setIsSidebarOpen(false)}
                  >
                    <span className={`mr-4 flex-shrink-0 h-6 w-6 ${
                      isActivePath(item.href) ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500'
                    }`}>
                      {item.icon}
                    </span>
                    {item.name}
